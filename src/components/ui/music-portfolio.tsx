...
const MusicPortfolio = ({PROJECTS_DATA=[], LOCATION={}, CALLBACKS={}, CONFIG={}, SOCIAL_LINKS={}}: any) => {
  ...
  const handleProjectMouseEnter = useCallback((index: number, imageUrl: string) => {
    ...
    setActiveProject(PROJECTS_DATA[index]);
  }, [activeIndex, stopIdleAnimation, stopIdleTimer, PROJECTS_DATA]);
  ...
  return (
    <>
      <div className="relative w-full min-h-screen bg-black text-white">
        ...
        {/* Music Artwork with Vinyl Animation */}
        <div className="music-artwork-container">
          {activeProject && (
            <MusicArtwork
              artist={activeProject.artist}
              music={activeProject.album}
              albumArt={activeProject.image}
              isSong={activeProject.category === 'SINGLE'}
