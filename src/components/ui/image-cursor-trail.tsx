        ...
        >
            {items.map((item, index) => (
                <img
                    key={index}
                    className={cn(
                        "opacity:0 absolute -translate-x-[50%] -translate-y-[50%] rounded-3xl object-cover transition-opacity duration-300 data-[status='active']:opacity-100 data-[status='active']:duration-500",
                        imgClass
                    )}
                    data-index={index}
