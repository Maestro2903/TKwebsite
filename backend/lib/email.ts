    ...
    html: `
      <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
        ...
        <p style="font-size: 16px; line-height: 1.6; color: #4b5563;">
          We're thrilled to have you join us for CIT Takshashila 2026. Get ready for an unforgettable experience filled with innovation, culture, and excitement.
        </p>
        <div style="background: #f3f4f6; padding: 24px; border-radius: 12px; margin: 24px 0;">
          <h2 style="font-size: 18px; color: #1f2937; margin-bottom: 12px;">Next Steps:</h2>
          <ul style="color: #4b5563; padding-left: 20px;">
            <li>Browse the events and shows</li>
            <li>Purchase your passes early</li>
            <li>Stay tuned for major announcements</li>
          </ul>
        </div>
